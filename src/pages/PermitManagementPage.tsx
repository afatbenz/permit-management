        ...
        <div className="card overflow-hidden">
          {paged.length === 0 ? (
            <EmptyState
              ...
              action={!search && statusFilter === 'all' ? <button onClick={() => navigate('/dashboard/permits/new')} className="btn-primary"><Plus className="h-4 w-4" /> Add Permit Baru</button> : undefined}
            />
          ) : (
